...
//
//  폭은 화면이 제각각 정하지 않는다 — PageShell 이 정한다.
//  업무 화면(default·wide)은 상한 없이 창 폭을 다 쓴다 — 넓은 모니터에서
//  좌우가 비는 것을 사용자가 싫어한다. 폭을 묶는 것은 빈 상태·오류(form)와
//  손으로 쓰는 모바일 화면(narrow)뿐이다.
// ============================================================
...
const widthCls = {
  /** 넓은 표·매트릭스 (원장·프로젝트·임포트) — 창 폭을 다 쓴다 */
  wide: "",
  /** 일반 업무 화면 — 창 폭을 다 쓴다 */
  default: "",
