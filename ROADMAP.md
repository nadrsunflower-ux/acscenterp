...
- [x] 마스터 적재 — 계정 317 · 계좌카드 27 · 자동분류 규칙 16 (API 경유로 적재 완료)
- [ ] **장부 임포트** — 임포트 탭에서 2605·2606·2607 올리기
- [ ] **`NEANDER_FINANCE_EMAILS` 채우기** — 지금은 비어 있어 팀원 5명 전원이 재무를 본다
- [ ] **Vercel 환경변수 등록** — `FIREBASE_SERVICE_ACCOUNT_B64` 없이 배포하면 재무만 500
- [ ] 2605·2606 은 **구스키마**(28열)라 구→신 분류 매핑이 필요할 수 있음 — 임포트 시 오류 행 확인
